...
// Start server
app.listen(port, () => {
  console.log(`🚀 ELE Mentorship API running on port ${port}`);
  console.log(`📊 Health check: http://localhost:${port}/api/health`);
  console.log(`👥 Mentors endpoint: http://localhost:${port}/api/mentors`);
  console.log(`🎓 Mentees endpoint: http://localhost:${port}/api/mentees`);
